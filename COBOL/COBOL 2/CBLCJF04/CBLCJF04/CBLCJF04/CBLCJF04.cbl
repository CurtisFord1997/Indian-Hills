       ...
       01 ITEMS.
           05 FILLER               PIC X(33)    
                   VALUE "00000000000SOFAS/LOVESEATS".
           05 FILLER               PIC X(33)  
                   VALUE "00000000000CHAIRS".
           05 FILLER               PIC X(33)  
                   VALUE "00000000000COFFEE/END TABLES".
           05 FILLER               PIC X(33)  
                   VALUE "00000000000DINING ROOM TABLES".
           05 FILLER               PIC X(33)  
                   VALUE "00000000000DINING ROOM CHAIRS".
           05 FILLER               PIC X(33)  
                   VALUE "00000000000HUTCHES/CURIO CABINETS".
           05 FILLER               PIC X(33)       
                   VALUE "00000000000LAMPS".
           05 FILLER               PIC X(33)  
                   VALUE"00000000000MATTRESS/BOX SPRINGS".
           05 FILLER               PIC X(33) 
                   VALUE "00000000000BEDROOM FURNITURE".
      ...
      **HEADERS FOR SUMMARY REPORT
       ...
       L3-CALCS.
           ...
           ADD ST-AMOUNT TO ITEM-TOTAL(ST-FUR-CODE).
      ...
      *PRINT DAY-TOTALS LINE...
       ...
       L4-PRINT-FURNATURE.
           ...
           MOVE ITEM-TOTAL(SINDX) TO O-ITEM-TOTAL.
